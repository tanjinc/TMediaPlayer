...
//    currentAsyncBuilder = new AsyncRendererBuilder(context, userAgent, url, drmCallback, player);
  ...
  private static final class AsyncRendererBuilder
    ...
    private final ExoVideoView player;
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url,
        MediaDrmCallback drmCallback, ExoVideoView player) {
      this.context = context;
      this.userAgent = userAgent;
...
//      player.onRenderersError(e);
    ...
    private ChunkSampleSource.EventListener mSampleListener = new ChunkSampleSource.EventListener() {
      @Override
    ...
    private void buildRenderers() {
      ...
      if (hasContentProtection) {
        if (Util.SDK_INT < 18) {
          Log.e(TAG, "video buildRenderers: ");
...
//        }
      ...
      ChunkSource videoChunkSource = new DashChunkSource(manifestFetcher,
          ...
          elapsedRealtimeOffset, mainHandler, null, 0);
      ChunkSampleSource videoSampleSource = new ChunkSampleSource(videoChunkSource, loadControl,
          VIDEO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, mSampleListener,
          0);
      MediaCodecVideoTrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(context, videoSampleSource,
      ...
      ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
          ...
          elapsedRealtimeOffset, mainHandler, null, 1);
      ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource, loadControl,
          AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, null,
          1);
