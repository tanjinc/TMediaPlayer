...
/**
 * Created by tanjincheng on 16/10/13.
 */
public class BatteryView extends View {
    private int mMargin = 5;    //电池内芯与边框的距离
    private int mBoder = 5;     //电池外框的宽带
    ...
    private void initView() {
        ...
        float left = mHeadRect.width() + mBoder;
        float top = mBoder;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(mMainRect, mRoudis, mRoudis, paint1);
        ...
        int right = (int) (left + mPower * (mMainRect.width() - mMargin*2));
